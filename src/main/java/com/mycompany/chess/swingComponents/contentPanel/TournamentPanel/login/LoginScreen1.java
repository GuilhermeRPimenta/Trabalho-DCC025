...
package com.mycompany.chess.swingComponents.contentPanel.TournamentPanel.login;
...
public class LoginScreen1 extends javax.swing.JPanel implements LoginScreenInterface {
    ...
    public LoginScreen1(TournamentGamePanel tournamentGamePanel) {
        initComponents();        
        this.tournamentGamePanel = tournamentGamePanel;
        controller = new LoginController<>(this, tournamentGamePanel);
    }
    ...
    private void loginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginButtonActionPerformed
        if (controller.confirmLoginTournament()) {
            TournamentGamePanel tournamentGamePanel = (TournamentGamePanel) this.getParent();
            tournamentGamePanel.removeAll();
            tournamentGamePanel.add(tournamentGamePanel.getLoginScreen2());
            tournamentGamePanel.repaint();
            tournamentGamePanel.revalidate();
        }
