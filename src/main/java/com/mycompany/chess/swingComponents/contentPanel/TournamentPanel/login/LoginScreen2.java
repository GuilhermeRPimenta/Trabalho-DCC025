...
public class LoginScreen2 extends javax.swing.JPanel implements LoginScreenInterface {
    ...
    public LoginScreen2(TournamentGamePanel tournamentGamePanel) {
        initComponents();
    ...
    private void loginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginButtonActionPerformed
        if (controller.confirmLoginTournament()) {
            ...
            tournamentGamePanel.getLoginScreen1().getController().logout(); // LOGOUT TELA 1
            controller.logout();                                            // LOGOUT LOGIN 2           
            
            tournamentGamePanel.startGame();           
            nameField.setText("");
